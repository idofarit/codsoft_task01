...
const Footer = () => {
  return (
    <div className=" mx-auto py-16 px-12 grid lg:grid-cols-3 gap-8 border-none text-black bg-white">
      <div>
        <h1 className="w-full text-3xl font-bold text-[#00df9a]">
          Single Page Demo Application
        </h1>
        <p className="py-4">
          Lo rem ipsum dolor sit amet consectetur adipisicing elit. Ipsum
          perspiciatis ipsa dolorum laudantium doloremque. Sed pariatur quia
          blanditiis exercitationem nesciunt!
        </p>
